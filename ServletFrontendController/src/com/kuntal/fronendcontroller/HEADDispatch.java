...
import com.kuntal.annotations.Annotations.HEAD;
 ...
 *
 */
public class HEADDispatch implements IDispatch {

	private static final Logger LOGGER = Logger.getLogger(HEADDispatch.class.getName());
	
	
	/**
	 * Sigleton class
	 */
	private HEADDispatch() {
	}
	
	private static HEADDispatch dispatch;
	/**
	 * Singleton design pattern using static block
	 */
	static {
		dispatch = new HEADDispatch();
	}

	public static HEADDispatch getHEADDispatcher() {
		return dispatch;
	}
