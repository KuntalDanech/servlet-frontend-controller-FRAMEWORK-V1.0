 ...
 *
 */
public class GETDispatch implements IDispatch {

	private static final Logger LOGGER = Logger.getLogger(GETDispatch.class.getName());
	...
	private static GETDispatch dispatch;

	/**
	 * Singleton design pattern using static block
	 */
	static {
		dispatch = new GETDispatch();
	}

	public static GETDispatch getGETDispatcher() {
		return dispatch;
	}
