 ...
 *
 */
public class OPTIONDispatch implements IDispatch {

	private static final Logger LOGGER = Logger.getLogger(OPTIONDispatch.class.getName());

	/**
	 * Sigleton class
	 */
	private OPTIONDispatch() {
	}
	private static OPTIONDispatch dispatch;
	
	/**
	 * Singleton design pattern using static block
	 */
	static {
		dispatch = new OPTIONDispatch();
	}

	public static OPTIONDispatch getOPTIONDispatcher() {
		return dispatch;
	}
