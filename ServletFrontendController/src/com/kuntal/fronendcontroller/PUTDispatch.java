...
import com.kuntal.annotations.Annotations.PUT;
 ...
 *
 */
public class PUTDispatch implements IDispatch {

	private static final Logger LOGGER = Logger.getLogger(PUTDispatch.class.getName());
	...
	private static PUTDispatch dispatch;
	/**
	 * Singleton design pattern using static block
	 */
	static {
		dispatch = new PUTDispatch();
	}

	public static PUTDispatch getPUTDispatcher() {
		return dispatch;
	}
