...
import com.kuntal.annotations.Annotations.TRACE;
 ...
 *
 */
public class TRACEDispatch implements IDispatch {

	private static final Logger LOGGER = Logger.getLogger(TRACEDispatch.class.getName());
	/**
	 * Sigleton class
	 */
	...
	private static TRACEDispatch dispatch;
	/**
	 * Singleton design pattern using static block
	 */
	static {
		dispatch = new TRACEDispatch();
	}

	public static TRACEDispatch getTRACEDispatcher() {
		return dispatch;
	}
